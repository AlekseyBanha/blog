...
�������� ������ �� Blade + ���������� (`core/custom/packages/main`) �� ���������� Evolution CMS 3:

- �������: `Home`, `Blog`, `Post`, `Page` (aliases: `home`, `blog`, `post_details`, `page`)
- �����: `src/views/*.blade.php` + `partials/`
- TV �����: `image`, `category`, `tags`
